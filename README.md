...
- **Data Cleaning and EDA:** *([Link](https://github.com/kibiipatrick/retail_supply_chain_sales_analysis/blob/main/sql%20files/retail_supply_chain_sales_queries.sql))*
 ...
 ### Python Scripts
- **Data Cleaning and EDA:** *([Link]((https://github.com/kibiipatrick/retail_supply_chain_sales_analysis/blob/main/python%20files/retail_supply_chain_sales_python.py)))*
---
